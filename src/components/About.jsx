        ...
        <body>
            <div className="about-container">
                <div className="about-child">
                    <img src={LadyWAStreet} alt=" Photo of Lady" width="500" height="500"/>
                </div>
                <div className="about-child">
                    ...
                    <p>
                        ...
                        WordPress and Shopify. I know the languages of Python, JavaScript, HTML and CSS. 
                        I enjoy building visually creative, easy to use, stylish websites for motivated individuals!
                    </p>
                </div>
